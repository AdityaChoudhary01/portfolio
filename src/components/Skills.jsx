      ...
      <div className="w-full md:w-12/12 lg:w-12/12 xl:w-8/12 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-10 mt-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <span className="cursor-pointer text-[60px] sm:text-[80px] md:text-[100px] text-blue-800 transition-all duration-300 hover:-translate-y-5">
              DSA with Java
            </span>
          </motion.div>
          {/* MERN */}
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <span className="cursor-pointer text-[60px] sm:text-[80px] md:text-[100px] text-green-500 transition-all duration-300 hover:-translate-y-5">
              MERN
            </span>
          </motion.div>
          {/* C++ */}
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <span className="cursor-pointer text-[60px] sm:text-[80px] md:text-[100px] text-red-500 transition-all duration-300 hover:-translate-y-5">
              C++
            </span>
          </motion.div>
          <motion.div
